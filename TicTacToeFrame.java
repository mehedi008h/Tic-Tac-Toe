...
public class TicTacToeFrame extends javax.swing.JFrame {
    ...
    {
        jLabel_Score.setText(playerOne+ "'s Score is : "+String.valueOf(playerOneCount)+" \t " +playerTurn + " 's Move " +playerTwo
    ...
    private void initComponents() {
        ...
        jLabel_Score.setBackground(new java.awt.Color(204, 255, 0));
        ...
        jPanel3.add(jLabel_Score, java.awt.BorderLayout.PAGE_END);
        ...
        jPanel3.add(jPanel_GridHolder, java.awt.BorderLayout.CENTER);
